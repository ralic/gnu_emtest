;;;_ tester/testhelp/match.el --- Expression matcher for EMtest
...
(defun emtm:make-struct-governor-x (sym depth accessor)
...
;;;_ , End
;;; tester/testhelp/match.el ends here
