;;;_ editor/insert.el --- emt-insert for inserting skeletons
...
function."
   ...
   (let
      ...
      (pp
	 `(emt:deftest-2 ,(intern suite-name)
	     ;;This is just `emt:insert-clause'
	     ( "Situation: WRITEME.
Response: WRITEME."
		(progn)))
