;;;_ emtest/main/notes.el --- Testral functions for emtest
...
See `emtt:testral:add-note-w/id'."
   (when (emtt:testral:p)
	 ...
	 args)))
;;;_   , emt:testral:with-parent-note
;;;###autoload
(defmacro emt:testral:with-parent-note (note-args &rest body)
...
;;;_ , End
;;; emtest/main/notes.el ends here
